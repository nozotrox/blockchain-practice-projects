...
1. Implement a messager functionality in a Smart Contract;
2. Through the constructor make sure you write the address that deployed the contract to a variable;
3. Create a message-variable of the type string, that only the deployer-address can update;
4. Create a counter, to see how many times the variable was updated;
...
<!-- GETTING STARTED -->
### Getting Started
For this project, there is no initial setup required. To test, copy the code and paste it on [Remix IDE](https://remix.ethereum.org/). Deploy the smart contract and... Happy Testing🪲
